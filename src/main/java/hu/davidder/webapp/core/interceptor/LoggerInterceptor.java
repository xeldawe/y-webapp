package hu.davidder.webapp.core.interceptor;
...
public class LoggerInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        logger.info("Pre -> [{}] {} [{}]", request.getMethod(), request.getRequestURI(), request.getRemoteAddr());
        return true;
    }
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
        logger.info("Post -> [{}][{}] {} [{}]", request.getMethod(), response.getStatus(), request.getRequestURI(), request.getRemoteAddr());
    }
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) throws Exception {
        if (ex != null) {
            logger.error("After -> [{}] {} [{}][exception: {}]", request.getMethod(), request.getRequestURI(), request.getRemoteAddr(), ex);
            ex.printStackTrace();
        }
    }
}